...
app.use(cors({
    origin: ['https://elnanofarinetes-backend.onrender.com'], // Canvia-ho si el teu frontend és en un altre port
    credentials: true
}));
...
app.listen(PORT, () => {
    console.log(`Servidor actiu a https://elnanofarinetes-backend.onrender.com:${PORT}`);
});
